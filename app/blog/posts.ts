...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "For leaders, the lesson is about continuity of purpose. The Beatles' music kept connecting people long after the band dissolved because the values embedded in it, creativity, authenticity, and collaboration, were timeless. Build those values into your organization's DNA, and your legacy will outlast you too.",
    ],
  },
  {
  ...
  },
  {
    ...
    excerpt:
      "Beatles songs about peace took on new meaning during my October visit to Hiroshima. While Daily Words of Wisdom explored social justice themes that month, I spent two weeks in Japan, a wonderfully clean, organized, and fascinating country.",
  ...
  // ── Leadership Lessons (latest → oldest) ────────────────────────────────
  {
  ...
  },
  {
    ...
    excerpt:
      "Before they were legends, they were just four guys grinding it out in Hamburg, eight hours a night, seven days a week. Those gigs didn't just toughen them up; they transformed them. In this post, we break down how the Beatles' most intense season became a blueprint for accelerated growth.",
  ...
  },
  {
    ...
    excerpt:
      "When the Beatles coined the phrase \"a hard day's night\" for their hit song and film, they weren't just creating a clever play on words: they were describing the reality of their journey to success. Before Beatlemania swept the world, the group endured grueling performances in Hamburg, playing up to eight hours a night, seven days a week.",
